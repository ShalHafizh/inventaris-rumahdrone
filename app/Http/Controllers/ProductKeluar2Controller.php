...
class ProductKeluar2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Staff.product_keluar.index', compact('products','customers', 'invoice_data'));
    }
    ...
    public function apiProductsOut2(){
