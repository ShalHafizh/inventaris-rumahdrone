...
class ProductMasuk2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Staff.product_masuk.index', compact('products','suppliers','invoice_data'));
    }
    ...
    public function apiProductsIn2(){
