            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets/img/logo.png')}}" style=" width: 200px; height: auto;" alt="Klorofil Logo"></div>
                                <p class="lead">Login ke Akun Anda <br><b>admin: admin@gmail.com &nbsp; pass: secret <br>staff: staff@gmail.com &nbsp; pass: staff123</b></p>
                            </div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Inventory Stock Managemen RUMAH DRONE</h1>
                            <p>by Muhammad Faishal Hafizh Mumtaz Galip</p>
                        </div>
                    </div>
